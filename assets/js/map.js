    ...
    !function() {
        ...
        function i(t) {
            ...
            e.setAttribute("type", "text/javascript"),
                ...
                e.addEventListener ? e.addEventListener("load", function(t) {
                ...
                window[s.guid] = window[s.guid] || {},
                    ...
                    s.event.un = function(t, e, i) {
                        ...
                        for (var n, o, a, r = s.event._listeners, h = r.length, d = !i; h--; )
                            n = r[h],
                            n[1] !== e || n[0] !== t || !d && n[2] !== i || (o = n[4],
                                a = n[3],
                                t.removeEventListener ? t.removeEventListener(o, a, !1) : t.detachEvent && t.detachEvent("on" + o, a),
                                r.splice(h, 1));
                        return t
                    }
                    ,
                    ...
                    s.dom._NAME_ATTRS = function() {
                        ...
                        return s.browser.ie < 8 ? (t["for"] = "htmlFor",
                            t["class"] = "className") : (t.htmlFor = "for",
                            t.className = "class"),
                            t
                    }(),
                    s.dom.setAttr = function(t, e, i) {
                        return t = s.dom.g(t),
                            "style" == e ? t.style.cssText = i : (e = s.dom._NAME_ATTRS[e] || e,
                                t.setAttribute(e, i)),
                            t
                    }
                    ,
                    ...
                    s.cookie.setRaw = function(t, e, i) {
                        if (s.cookie._isValidKey(t)) {
                            i = i || {};
                            var n = i.expires;
                            "number" == typeof i.expires && (n = new Date,
        ...
        o.prototype = new BMap.Overlay,
            ...
            o.prototype.open = function(t) {
                ...
                var e, i = this;
                this._isOpen || (this._map.addOverlay(this),
                    this._isOpen = !0,
                    setTimeout(function() {
                    ...
                    t instanceof BMap.Point ? (e = t,
                        this._removeMarkerEvt(),
                        this._marker = null) : t instanceof BMap.Marker && (this._marker && this._removeMarkerEvt(),
                        e = t.getPosition(),
                        this._marker = t,
                    !this._markerDragend && this._marker.addEventListener("dragend", this._markerDragend = function(t) {
                            i._point = t.point,
            ...
            o.prototype.close = function() {
                this._isOpen && (this._map.removeOverlay(this),
            ...
            s.object.extend(o.prototype, {
                ...
                _adjustPosition: function(t) {
                    ...
                    this._marker ? (this.container.style.bottom = -(e.y - this._opts.offset.height - i.anchor.height + i.infoWindowAnchor.height) - this._marker.getOffset().height + 2 + 30 + "px",
                        this.container.style.left = e.x - i.anchor.width + this._marker.getOffset().width + i.infoWindowAnchor.width - this._boxWidth / 2 + 28 + "px") : (this.container.style.bottom = -(e.y - this._opts.offset.height) + 30 + "px",
                ...
                _adjustContainerWidth: function() {
                    var t = 250;
                    this._opts.width ? (t = parseInt(this._opts.width, 10),
                        t += 10) : t = parseInt(this.dom.content.offsetWidth, 10),
                    250 > t && (t = 250),
                        this._width = t,
                ...
                _showTabContent: function(t) {
                    ...
                    for (var e = this.dom.navTab.getElementsByTagName("li"), i = e.length, n = 0, i = e.length; i > n; n++)
                        e[n].className = "";
                    switch (t) {
                ...
                _changeSearchRadius: function() {
                    ...
                    t > 0 && t != this._radius && (this._radius = t,
                ...
                _transitRouteComplete: function(t, e) {
                    ...
                    if (i == BMAP_STATUS_UNKNOWN_ROUTE) {
                        var n = e.getStartStatus()
                            ...
                            , o = "";
                        o = "找不到相关的线路",
                            n == BMAP_ROUTE_STATUS_EMPTY && s == BMAP_ROUTE_STATUS_EMPTY ? o = "找不到相关的起点和终点" : (n == BMAP_ROUTE_STATUS_EMPTY && (o = "找不到相关的起点"),
                            s == BMAP_ROUTE_STATUS_EMPTY && (o = "找不到相关的终点")),
                            "startPoint" == this._pointType && s == BMAP_ROUTE_STATUS_ADDRESS || "endPoint" == this._pointType && n == BMAP_ROUTE_STATUS_ADDRESS ? this._searchAddress(t) : (this.dom.panel.address.style.display = "block",
                ...
                _searchAddress: function(t) {
                    ...
                    i && (this.dom.panel.address.style.display = "block",
                ...
                _getTransPoi: function(t) {
                    var e, i;
                    return "startPoint" == this._pointType ? (e = this._point,
                        i = t) : (e = t,
                        i = this._point),
                    {
                        start: e,
                ...
                _setSearchTypes: function() {
                    ...
                    if (this.tabLength = e.length,
                        ...
                        for (o = 0; o < this.tabLength; o++) {
                            if (t = n[e[o]],
                                0 == o && (t.className = "BMapLib_first BMapLib_current",
                                    this._firstTab = t,
                                    r = e[o]),
                                o == this.tabLength - 1) {
                ...
                _mendIE6: function() {
                    if (s.browser.ie && !(s.browser.ie > 6))
                        for (var t = this.container.getElementsByTagName("IMG"), e = 0; e < t.length; e++)
                            t[e].src.indexOf(".png") < 0 || (t[e].style.cssText += ";FILTER: progid:DXImageTransform.Microsoft.AlphaImageLoader(src=" + t[e].src + ",sizingMethod=crop)",
        ...
        e.prototype = new BMap.Overlay,
            s.extend(e.prototype, {
                ...
                showTip: function(t) {
                    ...
                    this.renderImageVer(),
                    n && (this.dom.sms_tip.innerHTML = n,
                        this.dom.sms_tip.style.display = "inline"),
                    "SMS_SEND_SUCCESS" == e && (this.rememberPhone(),
                        this.sendSuccess())
                },
                bind: function() {
                    var t = this;
                ...
                checkActivateAction: function() {
                    ...
                    this.request(this.config.ckActivateURL, t, function(t) {
                        t && 0 != t.isactivate ? (e.dom.activateBox.style.display = "none",
                            e.dom.activateTip.style.color = "green",
                            e.dom.activateTip.innerHTML = "已激活") : (e.dom.activateBox.style.display = "table-row",
                ...
                sendAction: function() {
                    ...
                    if (this.validate()) {
                        ...
                        for (var e = this.dom.add_phone_con.getElementsByTagName("input"), i = 0, n = e.length; n > i; i++) {
                            if (!s.isPhone(e[i].value))
                                return void this.showTip({
                                    error: "PHONE_NUM_INVALID"
                                });
                ...
                validate: function() {
                    var t = !0;
                    return s.isPhone(this.dom.fromphone.value) && s.isPhone(this.dom.tophone.value) || (t = !1,
                        this.showTip({
                            error: "PHONE_NUM_INVALID"
                        })),
                        t
                ...
                getRememberPhone: function() {
                    ...
                    t && (this.dom.tophone.value = t,
                        this.dom.isRememberPhone.checked = !0)
                },
